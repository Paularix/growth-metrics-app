...
import { FEATURES_IN_PROD } from '@/src/constants/metrics';
import { getMainChartsData, getSalesBarData } from '@/src/utils/metricsUtils';

/**
 * Handles the state and rendering of Highcharts visualizations,
 * supporting dynamic drilldowns and category-based perspective filtering.
 */
